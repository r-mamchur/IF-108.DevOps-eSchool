...
echo "export JAVA_HOME=/usr/lib/jvm/java-1.8.0-openjdk-1.8.0.252.b09-2.el7_8.x86_64" >> /root/.bash_profile
echo "export PATH=$PATH:/opt/apache-maven-3.6.3/bin" >> /root/.bash_profile
...
sed -i -e "s|https://fierce-shore-32592.herokuapp.com|http://192.168.56.21|g" $app
...
sed -i -e "s|https://35.240.41.176:8443|http://192.168.56.21|g" $app_prod
